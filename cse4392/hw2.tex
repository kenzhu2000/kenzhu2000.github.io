...
Upon reviewing the table, you'll notice several zeros indicating absent bigrams from our training data. To overcome this, please apply Add-one Laplace Smoothing ($\alpha = 1$) to filling the following table the reconstituted counts. This adjustment 
...
\texttt{.py} source files, and a \texttt{README.md} file describing how to run the code.
The zip file must be named
\texttt{lastname\_studentID\_hw2.zip}.
}
