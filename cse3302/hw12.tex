...
\rhead{Homework 12: Object-oriented}
...
Submit one zip file via Canvas containing the \texttt{.pdf} version of your homework (including screenshots of the execution results and brief explanations for each program) and the corresponding source files. The zip file must be named \texttt{lastname\_studentID\_hw12.zip}.
}
\end{document}