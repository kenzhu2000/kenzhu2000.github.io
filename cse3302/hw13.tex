...
\author{Homework 13 - Fall 2025}
\date{Due Date: Nov. 17, 2025, 9:00PM Central Time}
\maketitle
\thispagestyle{fancy}

%----Homeworks----%

\textbf{Please include your source code file and a screenshot of execution result for each program problem in your submit.}
